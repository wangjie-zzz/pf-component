      ...
      <transition name="el-zoom-in-top">
        <slot v-if="shouldShowError" name="error" :error="validateMessage">
          <div
            ...
            :class="{
              'el-form-item__error&#45;&#45;inline': typeof inlineMessage === 'boolean' ? inlineMessage : elForm.inlineMessage || false
            }"
          >
            {{ validateMessage }}
          </div>
...
import { getPropByPath, useGlobalConfig } from 'element-plus/lib/utils/util.js'
...
import { ComponentSize } from "./token";
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const contentStyle = computed(() => {
      ...
      ret.width = `calc(80% - ${labelWidth}px)`
      return ret
    })
    ...
    const updateComputedLabelWidth = (width: any) => {
