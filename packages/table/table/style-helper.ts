import { onMounted, onUnmounted, computed, ref, watchEffect, watch, getCurrentInstance } from "vue";
import { addResizeListener, removeResizeListener } from "../util";
/* eslint-disable */
// @ts-ignore
import throttle from "lodash/throttle";
import { parseHeight } from "../util";
import { TableProps, Table, AnyObject, TableLayout, Store, TableColumnCtx } from "../table.type";

function useStyle(props: TableProps, layout: TableLayout, store: Store, table: any) {
  let $ElEMENT: any = {};
  const vm: any = getCurrentInstance();
  if ("$ELEMENT" in vm.proxy) {
    $ElEMENT = vm.proxy.$ELEMENT;
  }
  ...
  const handleHeaderFooterMousewheel = (event: any, data: { pixelX: any; pixelY?: any }) => {
